...
The Online Documentation is accessible [here](https://docs.aceql.com/rest/soft_csharp/7.0/csharpdoc_sdk/html/N-AceQL.Client.Api.htm).
...
Downloading a schema into a  `File` is done through the method. See the `RemoteDatabaseMetaData` [Documentation](https://docs.aceql.com/rest/soft_csharp/7.0/csharpdoc_sdk):
...
See an example of the built HTML schema:  [db_schema.out.html](https://docs.aceql.com/rest/soft_csharp/7.0/src/db_schema.out.html)
...
See the `RemoteDatabaseMetaData` [Documentation](https://docs.aceql.com/rest/soft_csharp/7.0/csharpdoc_sdk):
